#define SMTP_SERVER "Plato.eworx.gr"
#define SMTP_USER_BASE64 "ZXdvcngtbmtv"
#define SMTP_PASS_BASE64 "bjFrMHV2M2xAc18="

#define SMTP_FROM_EMAIL "nko@eworx.com"
#define SMTP_TO_EMAIL "aka@eworx.com"
#define SMTP_SUBJECT "Email from a Photon(serverRoom)!"
...
void setup() {
    pinMode(D5, INPUT);
    Particle.variable("emailSent", &sentOnce, INT);
